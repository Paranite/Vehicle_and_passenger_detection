# https://github.com/Linzaer/Ultra-Light-Fast-Generic-Face-Detector-1MB/tree/master/tf
...
parser.add_argument('--img_path', default='../model_data/faces.jpg', type=str,
...
def main():
    ...
    cv2.imwrite(f'test_output_{args.net_type}.jpg', img)
